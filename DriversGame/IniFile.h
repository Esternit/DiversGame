...
public:
    ...
    /// @note При чтении строка должна сопоставляться со всеми значениям из
    /// trueValues, независимо от регистра
...
/*
Задача: реализовать класс для работы с файлами конфигурации формата .ini по
предложенному интерфейсу Файл имеет следующий формат:
...
Файл может содержать:
    ...
    - пустые строки;
    - ошибочные строки - секции без имени, значения без ключа, ключ без
значения, множественные '[', ']', '=' и т.д.
